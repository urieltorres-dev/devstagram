    ...
    <div class="md:flex md:justify-center">
        <div class="md:w-1/2 bg-white shadow p-6">
            <form enctype="multipart/form-data" method="POST" action="{{ route('perfil.store') }}" class="mt-10 md:mt-0">
                ...
                <input type="submit" value="Actualizar perfil" class="uppercase p-3 bg-sky-600 transition-colors hover:bg-sky-700 cursor-pointer font-bold w-full text-white rounded-lg" />
            </form>
        </div>
    </div>
@endsection
